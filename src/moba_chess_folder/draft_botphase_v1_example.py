...
for i in range(2):
    ...
    # Second player (bot) chooses a character to ban
    ban_choice = bot_choose_character_to_ban(characters)
    banned_characters.append(ban_choice)
    characters.remove(ban_choice)
    print(f"{second_picker} bans {ban_choice}.")
...
for i in range(2):
    ...
    # Second player (bot) chooses a character to pick
    pick_choice = bot_choose_character_to_pick(characters)
    drafted_characters.append(pick_choice)
    characters.remove(pick_choice)
    print(f"{second_picker} picks {pick_choice}.")
